...
![프레임없음|745x745픽셀](../../_assets/1.8.1._주요_안전_기능(Hi6)-주요_안전_기능.png  )

![프레임없음|945x945픽셀](../../_assets/그림_1.2_제어기,_티칭펜던트_비상정지_스위치.png  )

그림 1.2 제어기, 티칭펜던트 비상정지 스위치

![프레임없음|492x492픽셀](../../_assets/그림_1.3_추가_비상정지_장치_연결.png  )
