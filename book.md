...
그림 4.49 티치펜던트 TP630의 외관
# 4.3.6.2. USB 커버

티치펜던트 옆면 고무커버 아래 USB A type 커넥터가 장착되어 있으므로, 사용자는 USB Memory Stick을 이용하여 각종 보드류의 버전뿐만 아니라 데이터 및 티칭 프로그램 등 필요한 파일들을 업/다운 로드 할 수  습니다.
# 5. 제어기의 선택구성
# 5.1. PCI 통신 카드
# 5.1.1. 개요
